    ...
    <section className="relative min-h-screen flex flex-col lg:flex-row gap-8 max-w-[85%] xl:max-w-8xl mx-auto py-32 justify-between items-center overflow-visible">
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden">
        <div className="absolute top-0 left-0 w-full h-full">
          ...
          <div 
            className="absolute top-1/3 right-1/3 w-32 h-32 rounded-blob bg-accent-500/5 dark:bg-accent-400/5 animate-morph"
          ...
          ></div>
          <div 
            className="absolute top-2/3 right-1/4 w-24 h-24 border border-primary-500/10 dark:border-primary-400/10 rounded-full animate-spin-slow"
      ...
      <div className={`text-left space-y-8 w-full lg:w-1/2 transition-all duration-1000 transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}>
        ...
        <nav className="flex flex-wrap gap-4 mt-8 mb-8 lg:mb-0">
          <button
            ...
            className="group relative w-full sm:w-auto px-8 py-3 bg-primary-700 dark:bg-secondary-300 text-white dark:text-slate-950 font-bold rounded-lg overflow-hidden transition-all duration-300 hover:shadow-lg hover:scale-105"
          >
          ...
          <a
            ...
            className="group flex items-center justify-center w-full sm:w-auto px-8 py-3 border-2 border-primary-700 dark:border-secondary-300 text-primary-700 dark:text-secondary-300 font-bold rounded-lg transition-all duration-300 hover:shadow-lg hover:scale-105 hover:bg-primary-50 dark:hover:bg-secondary-900/20"
          >
            {darkMode === 'dark' ? (
          ...
          <div className="relative w-full sm:w-auto" ref={dropdownRef}>
            <button 
              ...
              className="group flex items-center justify-center w-full px-8 py-3 border-2 border-primary-700 dark:border-secondary-300 text-primary-700 dark:text-secondary-300 font-bold rounded-lg transition-all duration-300 hover:shadow-lg hover:scale-105 hover:bg-primary-50 dark:hover:bg-secondary-900/20"
            >
              ...
              <div className="absolute left-0 mt-2 w-full sm:w-48 bg-white dark:bg-dark-100 shadow-xl border border-gray-200 dark:border-dark-300 rounded-lg z-[9999] animate-fade-in">
                <div className="p-1">
                  <a
                    href="/cv-tr.pdf"
                    download
                    className="flex items-center px-4 py-3 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-dark-200 transition-colors duration-200 rounded-md group"
                  >
                    <span className="relative">
                      Türkçe CV
      ...
      <div 
        ref={heroImageRef}
        className={`relative mt-20 lg:mt-0 group w-full lg:w-1/2 flex justify-center lg:justify-end lg:pr-8 transition-all duration-1000 transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`} 
      ...
      >
        <div className="relative z-0 perspective">
          ...
          >
            <img
              className="rounded-2xl w-full max-w-[450px] max-h-[375px] object-cover shadow-2xl transition-all duration-500 group-hover:scale-[1.03] group-hover:shadow-neon-purple dark:group-hover:shadow-neon"
              src="../image.png"
              alt="Hero image"
            />
            ...
            {/* 3D effect layers */}
            <div 
              className="absolute inset-0 rounded-2xl border-2 border-white/20 dark:border-white/10 transform preserve-3d backface-hidden"
              style={{ 
            ...
            ></div>
            <div 
              className="absolute inset-0 rounded-2xl bg-gradient-to-tr from-primary-500/5 to-secondary-500/5 dark:from-primary-500/10 dark:to-secondary-500/10 transform preserve-3d backface-hidden"
              style={{ 
            ...
            <div 
              className="absolute -bottom-6 -right-6 w-32 h-32 bg-primary-500/10 dark:bg-secondary-500/10 rounded-full blur-2xl transition-all duration-500 group-hover:scale-120"
              style={calculateParallaxTransform(2)}
            ></div>
            <div 
              className="absolute -top-6 -right-6 w-32 h-32 bg-secondary-500/10 dark:bg-primary-500/10 rounded-full blur-2xl transition-all duration-500 group-hover:scale-120"
              style={calculateParallaxTransform(1.5)}
            ></div>
            
            {/* Floating elements */}
            <div 
              className="absolute -top-8 -left-8 w-16 h-16 bg-primary-500/30 dark:bg-primary-400/20 rounded-full blur-md animate-float"
              style={calculateParallaxTransform(3)}
            ></div>
            <div 
              className="absolute -bottom-10 -right-6 w-20 h-20 bg-secondary-500/30 dark:bg-secondary-400/20 rounded-full blur-md animate-pulse-slow" 
              style={{...calculateParallaxTransform(2.5), animationDelay: '1s'}}
            ></div>
            
            {/* Corner accents */}
            <div 
              className="absolute -top-1 -left-1 w-6 h-6 bg-primary-500/50 dark:bg-primary-400/30 rounded-md transform rotate-45 animate-pulse-slow" 
              style={{...calculateParallaxTransform(4), animationDelay: '0.5s'}}
            ></div>
            <div 
              className="absolute -bottom-1 -right-1 w-6 h-6 bg-secondary-500/50 dark:bg-secondary-400/30 rounded-md transform rotate-45 animate-pulse-slow" 
              style={{...calculateParallaxTransform(4), animationDelay: '1.5s'}}
            ></div>
            
            {/* Yeni eklenen 3D efekt elemanları */}
            <div 
              className="absolute -top-3 -right-3 w-8 h-8 rounded-full bg-accent-500/40 dark:bg-accent-400/30 transform preserve-3d backface-hidden animate-bounce-slow"
              style={{ 
            ...
            ></div>
            <div 
              className="absolute -bottom-3 -left-3 w-8 h-8 rounded-full bg-highlight-500/40 dark:bg-highlight-400/30 transform preserve-3d backface-hidden animate-bounce-slow"
              style={{ 
            ...
            {/* Işık efekti */}
            <div 
              className="absolute inset-0 rounded-2xl bg-gradient-to-tr from-white/0 to-white/20 dark:from-white/0 dark:to-white/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500"
              style={{ 
