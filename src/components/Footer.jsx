...
const Footer = () => {
  ...
  return (
    <footer id="footer" className="bg-gradient-to-b from-gray-50 to-white dark:from-[#1a1a1f] dark:to-[#242128] py-16 sm:py-24">
      <div className="max-w-[85%] xl:max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white dark:bg-[#2a2a32] rounded-2xl p-6 sm:p-12 shadow-xl">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-black dark:text-gray-400 mb-8 sm:mb-12 max-w-2xl group">
            {footer.collabHeader}
          ...
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8">
            ...
            <nav className="flex flex-wrap gap-4 sm:gap-6 w-full lg:w-auto justify-center lg:justify-end">
              ...
              >
                <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gray-100 dark:bg-purple-900/30 rounded-lg flex items-center justify-center mr-2 sm:mr-3 transition-all duration-300 group-hover:bg-blue-50 dark:group-hover:bg-purple-900/50 group-hover:scale-110">
              ...
              >
                <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gray-100 dark:bg-green-900/30 rounded-lg flex items-center justify-center mr-2 sm:mr-3 transition-all duration-300 group-hover:bg-green-50 dark:group-hover:bg-green-900/50 group-hover:scale-110">
              ...
              >
                <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gray-100 dark:bg-blue-900/30 rounded-lg flex items-center justify-center mr-2 sm:mr-3 transition-all duration-300 group-hover:bg-blue-50 dark:group-hover:bg-blue-900/50 group-hover:scale-110">
                  <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="currentColor" viewBox="0 0 24 24">
