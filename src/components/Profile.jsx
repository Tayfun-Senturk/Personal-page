          ...
          >
            ...
            <div className="space-y-6">
              {profile?.basicInfo?.infoItems?.map((info, index) => (
                <div key={index} className="group flex items-center hover:bg-gray-50 dark:hover:bg-dark-200/50 p-3 rounded-xl transition-all duration-300 transform hover:scale-[1.02]">
                  <div className="w-12 h-12 bg-primary-50 dark:bg-primary-900/20 rounded-lg flex items-center justify-center mr-4 group-hover:bg-primary-100 dark:group-hover:bg-primary-900/30 transition-colors duration-300 shadow-md group-hover:shadow-lg">
                    {index === 0 && (
                      <svg className="w-6 h-6 text-primary-700 dark:text-secondary-300 transition-transform duration-300 group-hover:scale-110" fill="none" stroke="currentColor" viewBox="0 0 24 24">
