...
const Skills = () => {
  ...
  return (
    <section id="skills" className=" border-b border-purple-200 py-16 place-content-between text-left max-w-[80%] xl:max-w-7xl m-auto ">
      ...
      {skills?.skillsList?.map((skill) => (
        <div className="max-w-[30%] text-left">
          <h3 className="text-xl font-bold dark:text-purple-300 text-blue-800">{skill.skillName}</h3>
