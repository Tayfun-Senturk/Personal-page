          ...
          {Object.entries(skills.categories).map(([key, category]) => (
            <div key={key} className="space-y-6 sm:space-y-8">
              <div className="flex items-center space-x-4">
                ...
                <h3 className="text-2xl sm:text-3xl font-bold text-blue-800 dark:text-purple-300">
                  {category.title}
                </h3>
              </div>
              ...
              <div className="grid gap-4 sm:gap-6">
                {category.skills.map((skill, index) => (
                  ...
                  >
                    <div className="relative p-6 sm:p-8 bg-white dark:bg-[#2a2a32] rounded-2xl shadow-lg hover:shadow-xl transition-all duration-500 transform hover:-translate-y-2 hover:rotate-y-2 h-full flex flex-col">
                      <div className="relative z-10 flex-1">
                        <div className="flex items-center mb-4 sm:mb-6">
                          <h3 className="text-xl sm:text-2xl font-bold text-blue-800 dark:text-purple-300 group-hover:text-blue-600 dark:group-hover:text-purple-200 transition-colors duration-300">
                            {skill.skillName}
                          </h3>
                        </div>
                        ...
                        <div className="mt-4 sm:mt-6 h-1 w-full bg-gradient-to-r from-blue-500/20 to-purple-500/20 rounded-full overflow-hidden">
                      ...
                      <div className="absolute -top-2 -left-2 w-8 sm:w-12 h-8 sm:h-12 bg-blue-100/30 dark:bg-purple-900/30 rounded-lg transform rotate-12 group-hover:rotate-0 transition-transform duration-500"></div>
                      <div className="absolute -bottom-2 -right-2 w-8 sm:w-12 h-8 sm:h-12 bg-purple-100/30 dark:bg-blue-900/30 rounded-lg transform -rotate-12 group-hover:rotate-0 transition-transform duration-500"></div>
